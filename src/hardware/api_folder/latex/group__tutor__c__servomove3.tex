\hypertarget{group__tutor__c__servomove3}{}\doxysection{PVT trajectory for three servos}
\label{group__tutor__c__servomove3}\index{PVT trajectory for three servos@{PVT trajectory for three servos}}
...
{\bfseries{Important!}}Before setting up PVT points, make sure to change the default CAN IDs of the servos (see the \mbox{\hyperlink{group__tutor__c__change_i_d1}{Changing CAN ID of a single servo}} tutorial).
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    \mbox{\hyperlink{structrr__servo__t}{rr\_servo\_t}} *servo3 = \mbox{\hyperlink{group___init_ga88467da814964fd147ab9c7c7af0ed21}{rr\_init\_servo}}(iface, id3);}
\DoxyCodeLine{    \textcolor{keywordflow}{if}(!servo3)}
\DoxyCodeLine{    \{}
\DoxyCodeLine{        \mbox{\hyperlink{api_8h_a0e4aafa2ca9bd25219713176906b7c40}{API\_DEBUG}}(\textcolor{stringliteral}{"{}Servo \#2 init error\(\backslash\)n"{}});}
\DoxyCodeLine{        \textcolor{keywordflow}{return} 1;}
\DoxyCodeLine{    \}}
...
\item Clear points in the motion queue of servo 1. 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    \mbox{\hyperlink{group___trajectory_ga7b5be2d97da325eefde671c2e65e8055}{rr\_clear\_points\_all}}(servo1);}

\end{DoxyCodeInclude}

\item Clear points in the motion queue of servo 2. 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    \mbox{\hyperlink{group___trajectory_ga7b5be2d97da325eefde671c2e65e8055}{rr\_clear\_points\_all}}(servo2);}

\end{DoxyCodeInclude}

\item Clear points in the motion queue of servo 3. 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    \mbox{\hyperlink{group___trajectory_ga7b5be2d97da325eefde671c2e65e8055}{rr\_clear\_points\_all}}(servo3);}

\end{DoxyCodeInclude}
 {\bfseries{ Adding PVT ponts to form motion queues }}
...
\item Set the first PVT point for servo 3, commanding it to move to the position of 100 degrees in 6,000 milliseconds. 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    status = \mbox{\hyperlink{group___trajectory_gacf26f2966a4f2035a128e1fcecd08f58}{rr\_add\_motion\_point}}(servo3, 100.0, 0.0, 6000);}
\DoxyCodeLine{    \textcolor{keywordflow}{if}(status != \mbox{\hyperlink{api_8h_a92d5be5038abcf89837faf85a08debdca4894234446e2d92068943b3d6d3a0bdc}{RET\_OK}})}
\DoxyCodeLine{    \{}
\DoxyCodeLine{        \mbox{\hyperlink{api_8h_a0e4aafa2ca9bd25219713176906b7c40}{API\_DEBUG}}(\textcolor{stringliteral}{"{}Error in the trjectory point calculation: \%d\(\backslash\)n"{}}, status);}
\DoxyCodeLine{        \textcolor{keywordflow}{return} 1;}
...
\item Set the second PVT point for servo 3, commanding it to move to the position of -\/100 degrees in 6,000 milliseconds. 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    status = \mbox{\hyperlink{group___trajectory_gacf26f2966a4f2035a128e1fcecd08f58}{rr\_add\_motion\_point}}(servo3, -\/100.0, 0.0, 6000);}
\DoxyCodeLine{    \textcolor{keywordflow}{if}(status != \mbox{\hyperlink{api_8h_a92d5be5038abcf89837faf85a08debdca4894234446e2d92068943b3d6d3a0bdc}{RET\_OK}})}
\DoxyCodeLine{    \{}
...
\DoxyCodeLine{    \mbox{\hyperlink{group___state_ga0b1d17a317892471c6df1440e92da9d8}{rr\_servo\_set\_state\_operational}}(servo3);}
\DoxyCodeLine{}
\DoxyCodeLine{    \mbox{\hyperlink{api_8h_a0e4aafa2ca9bd25219713176906b7c40}{API\_DEBUG}}(\textcolor{stringliteral}{"{}========== Tutorial of the \%s ==========\(\backslash\)n"{}}, \textcolor{stringliteral}{"{}controlling three servos"{}});}
\DoxyCodeLine{}
\DoxyCodeLine{    \mbox{\hyperlink{group___trajectory_ga7b5be2d97da325eefde671c2e65e8055}{rr\_clear\_points\_all}}(servo1);}
\DoxyCodeLine{    \mbox{\hyperlink{group___trajectory_ga7b5be2d97da325eefde671c2e65e8055}{rr\_clear\_points\_all}}(servo2);}
\DoxyCodeLine{    \mbox{\hyperlink{group___trajectory_ga7b5be2d97da325eefde671c2e65e8055}{rr\_clear\_points\_all}}(servo3);}
